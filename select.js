                ...
                .on('mousedown',function(data){
                    ...
                    d3.csv( "all_product_export/"+data.id+"_all_product_ex.csv", function (productdata) {
                        ...
                        var minHeight=d3.min(newDataset, function(d) {
                            return d3.min(d, function(d) { return (d.y0); });//d.y +
                        });
                        ...
                        baseGroup.append("g")
                            .attr("class", "xaxis")
                            .attr("transform", "translate(0," + height_stream + ")")//height_stream
                            .call(xBar);
                        ...
                        var area = d3.svg.area()
                            ...
                            .y0(function(d) {
                                //console.log(d.x, yScale(d.y0))
                                return yScale(d.y0); })
                            .y1(function(d) { return yScale((d.y +d.y0)); });//d.y +
                        ...
                        var color = d3.scale.category20c();   //有二十种颜色的颜色比例尺
